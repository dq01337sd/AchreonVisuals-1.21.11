...
public class FluidGlassPipeline {
    ...
    public static void init() {
        ...
        pipeline = RenderPipeline.builder()
                .withLocation(Identifier.of("atheryx", "fluid_glass"))
                .withVertexShader(Identifier.of("atheryx", "liquid_glass_vertex"))
                .withFragmentShader(Identifier.of("atheryx", "fluid_glass_fragment"))
