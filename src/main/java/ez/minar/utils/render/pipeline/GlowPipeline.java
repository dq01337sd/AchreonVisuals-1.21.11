...
public class GlowPipeline {
    ...
    public static void init() {
        ...
        try {
            pipeline = RenderPipeline.builder()
                    .withLocation(Identifier.of("atheryx", "glow"))
                    .withVertexShader(Identifier.of("atheryx", "glow_vertex"))
                    .withFragmentShader(Identifier.of("atheryx", "glow_fragment"))
    ...
    public static void draw(Matrix4f matrix, float x, float y, float size, int color, float z) {
        if (pipeline == null)
            init();
        ...
        buffer.position(64);
        buffer.putFloat(x).putFloat(y).putFloat(size).putFloat(z);
