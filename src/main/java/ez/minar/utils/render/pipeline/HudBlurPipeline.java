...
public class HudBlurPipeline {
    ...
    public static void init() {
        ...
        pipeline = RenderPipeline.builder()
                .withLocation(Identifier.of("atheryx", "hud_blur"))
                .withVertexShader(Identifier.of("atheryx", "hud_blur_vertex"))
                .withFragmentShader(Identifier.of("atheryx", "hud_blur_fragment"))
