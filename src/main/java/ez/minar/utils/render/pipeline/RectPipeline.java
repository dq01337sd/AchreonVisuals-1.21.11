...
public class RectPipeline {
    ...
    public static void init() {
        ...
        try {
            pipeline = RenderPipeline.builder()
                    .withLocation(Identifier.of("atheryx", "rectangle"))
                    .withVertexShader(Identifier.of("atheryx", "rectangle_vertex"))
                    .withFragmentShader(Identifier.of("atheryx", "rectangle_fragment"))
    ...
    public static void draw(Matrix4f matrix, float x, float y, float width, float height, float tl, float tr, float br,
        ...
        buffer.putFloat(0).putFloat(0).putFloat(0); // _pad, _pad2 (float + vec2)
